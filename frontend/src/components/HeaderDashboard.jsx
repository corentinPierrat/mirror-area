    ...
    <header className={styles.header}>
      <nav className={styles.navbar}>
        <div className={styles['nav-left']}>
          ...
          <li><img src="/arrow.PNG" className={styles.navicons} alt="arrow" /><a href="#">Dashboard</a></li>
              <li><img src="/arrow.PNG" className={styles.navicons} alt="arrow" /><a href="#">Cr-rea</a></li>
